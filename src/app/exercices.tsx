...
const styles = StyleSheet.create({
  ...
  ttsBtn: { backgroundColor: '#0F172A', borderWidth: 1, borderColor: '#334155', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4 },
  ttsBtnText: { fontSize: 18 },
  microBtn: { backgroundColor: '#0F172A', borderWidth: 1, borderColor: '#8B5CF6', borderRadius: 8, padding: 12, alignItems: 'center', marginBottom: 15 },
  microBtnActif: { backgroundColor: '#2D1F40' },
  ...
  boutonSymbole: { backgroundColor: '#0F172A', borderWidth: 1, borderColor: '#334155', borderRadius: 8, width: '12%', paddingVertical: 8, alignItems: 'center' },
  texteSymbole: { color: '#94A3B8', fontSize: 17, fontWeight: 'bold' },
  cardTitle: { color: '#10B981', fontSize: 17, fontWeight: 'bold', flex: 1 },
  ...
  aiIntro: { color: '#94A3B8', fontSize: 14, fontStyle: 'italic', marginBottom: 15 },
  ...
  aiBtn: { backgroundColor: '#8B5CF6', padding: 15, borderRadius: 8, alignItems: 'center', marginTop: 5 },
