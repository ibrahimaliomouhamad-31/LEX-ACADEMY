...
const REVISER: Fonctionnalite[] = [
  ...
  { emoji: '📈', titre: 'Statistiques', titreEn: 'Statistics', description: 'Activité, taux de réussite, progression', descriptionEn: 'Activity, success rate, progress', route: '/statistiques', couleur: '#06B6D4' },
    { emoji: '🍃', titre: 'Exercices infinis', titreEn: 'Endless practice', description: 'Pratique illimitée sur TOUTES les micro-notions de chaque chapitre', descriptionEn: 'Endless drilling on ALL sub-topics of each chapter', route: '/entrainement_infini', couleur: '#10B981' },
