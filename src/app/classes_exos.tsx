...
export default function ClassesExos() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Exercices - Choisis ta classe</Text>
      </View>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        {classes.map((cls, index) => (
          <TouchableOpacity 
            ...
            onPress={() => router.push({ pathname: '/matieres_exos', params: { classe: cls.nom } })}
          >
...
const styles = StyleSheet.create({
  ...
  card: { flexDirection: 'row', backgroundColor: '#1E293B', borderRadius: 15, padding: 20, marginBottom: 15, alignItems: 'center', borderLeftWidth: 4 },
